var AdCampaign = location.search.split("exl_acp=")[1];
...
function getAddClass() {
	return $("#productType").val() == "3" ? "LT-102" : "LT-14";
}

function getRemoveClass() {
	return $("#productType").val() == "3" ? "LT-103" : "LT-19";
}
...
function updateBookBtn() {
	const langClass = $("#productType").val() == "3" ? "LT-101" : "LT-11";
...
function populateFromCookie(productNames = null) {
	...
	// $(".shopping-cart .journey-name").val(data["journeyName_MG"]);
...
$(document).ready(function () {
	...
	//js to set up hachinohe wordpress
...
function setUpHachinoheWordpress() {
	...
	let headingImage = "https://hadi.txi.co.id/hachinohe/images/all_TOP.jpg";
	switch (productType) {
		case "0":
			headingImage =
				"https://hadi.txi.co.id/hachinohe/images/accommodations_TOP.jpg";
			break;
		case "1":
			headingImage =
				"https://hadi.txi.co.id/hachinohe/images/activities_TOP.jpg";
			break;
		case "2":
			headingImage =
				"https://hadi.txi.co.id/hachinohe/images/restaurants_TOP.jpg";
			break;
		case "3":
			headingImage = "https://hadi.txi.co.id/hachinohe/images/produce_TOP.jpg";
			break;
		default:
			break;
	}
...
function getProductType() {
	...
	productType = productType != "0" && productType != "1" ? null : productType;
